...
test_loss = evaluate(transformer, test_dataloader, criterion)
...
def show_bleu(data, src_field, trg_field, model, device, max_len=50):
    ...
    for datum in data:
        src = datum['de']
        trg = datum['en']
        trg = [trg_field.vocab.itos[i] for i in trg][1:]
        trg = trg[:-1]
...
show_bleu(test_dataset, test_dataset.SRC, test_dataset.SRC, transformer, device)